...
export class VonageAccountApi implements ICredentialType {
	name = 'N8nDevVonageAccountApi';

	displayName = 'vonage-account API';

	icon: Icon = { light: 'file:../nodes/VonageAccount/vonage-account.svg', dark: 'file:../nodes/VonageAccount/vonage-account.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: 'https://api.vonage.com/t/vbc.prod/provisioning',
			description: 'The base URL of your vonage-account API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
